...
try {
    $madeAlready = Test-Path -Path $icoPath
    if (-not $madeAlready) {
...
Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management\PrefetchParameters' `
    ...
    Set-RegistryValue -Path "Registry::HKEY_USERS\$hive\Control Panel\Accessibility\HighContrast" `
        -Name 'Flags' `
        -Type 'String' `
        -Value '4194' `
...
Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\userAccountLog' `
    -Name 'Value' `
    -Type 'String' `
    -Value 'Deny' `
...
Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\Maintenance' `
    -Name 'MaintenanceDisabled' `
    -Type 'DWord' `
    -Value '0' `
    -Desc 'Automatic Maintenance'
...
Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge' `
    -Name 'HubshiveebarEnabled' `
    -Type 'DWord' `
    -Value 0 `
    -Desc 'Edge Copilot hiveebar'
...
Remove-RegistryKey -Path 'Registry::HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\Explorer\Desktop\NameSpace\{f874310e-b6b7-47dc-bc84-b9e6b38f5903}' `
  -Desc 'Display the Home folder in the navigation pane as a shortcut to your user profile folder'

Remove-RegistryKey -Path 'Registry::HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\Explorer\Desktop\NameSpace\{e88865ea-0e1c-4e20-9aa6-edcd0212c87c}' `
  -Desc 'Display the Gallery folder in the navigation pane for quick access to all your photos and videos'
...
Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\Explorer' `
  ...
  -Desc 'Show web results from Bing alonghivee local files and apps when searching in the Start Menu'
    ...
    -Type 'DWord' `
    -Value 0 `
    -Desc 'Display recently opened documents and files in Start Menu Recommended section for quick access'
    ...
    -Type 'DWord' `
    -Value 0 `
    -Desc 'Display personalized Windows suggestions such as tips, shortcuts, and Microsoft Store app recommendations in Recommended section'
...
Write-Log "Configuring clean Start Menu layout..."
...
Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\DisplayEnhancementService' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for DisplayEnhancementService'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\PcaSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for PcaSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WdiSystemHost' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for WdiSystemHost'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AudioEndpointBuilder' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for AudioEndpointBuilder'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\DeviceAssociationService' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for DeviceAssociationService'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NcbService' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for NcbService'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\StorSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for StorSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SysMain' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for SysMain'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TextInputManagementService' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for TextInputManagementService'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TrkWks' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for TrkWks'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\hidserv' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for hidserv'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Appinfo' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for Appinfo'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\BITS' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for BITS'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\LanmanServer' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for LanmanServer'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SENS' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for SENS'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Schedule' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for Schedule'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\ShellHWDetection' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for ShellHWDetection'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Themes' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for Themes'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TokenBroker' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for TokenBroker'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\UserManager' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for UserManager'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\UsoSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for UsoSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Winmgmt' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for Winmgmt'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WpnService' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for WpnService'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\gpsvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for gpsvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\iphlpsvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for iphlpsvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\wuauserv' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for wuauserv'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WinHttpAutoProxySvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for WinHttpAutoProxySvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\EventLog' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for EventLog'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TimeBrokerSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for TimeBrokerSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\lmhosts' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for lmhosts'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Dhcp' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for Dhcp'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\FontCache' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for FontCache'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\nsi' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for nsi'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\netprofm' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for netprofm'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SstpSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for SstpSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\DispBrokerDesktopSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for DispBrokerDesktopSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\CDPSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for CDPSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\EventSystem' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for EventSystem'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\LicenseManager' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for LicenseManager'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SystemEventsBroker' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for SystemEventsBroker'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Power' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for Power'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\LSM' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for LSM'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\DcomLaunch' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for DcomLaunch'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\BrokerInfrastructure' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for BrokerInfrastructure'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\CoreMessagingRegistrar' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for CoreMessagingRegistrar'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\DPS' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for DPS'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NcdAutoSetup' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for NcdAutoSetup'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AppXSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for AppXSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\ClipSVC' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for ClipSVC'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\camsvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for camsvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\StateRepository' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for StateRepository'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\FDResPub' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for FDResPub'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SSDPSRV' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for SSDPSRV'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\CryptSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for CryptSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Dnscache' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for Dnscache'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NlaSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for NlaSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\LanmanWorkstation' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for LanmanWorkstation'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\KeyIso' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for KeyIso'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\VaultSvc' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for VaultSvc'

Set-RegistryValue -Path 'Registry::HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SamSs' `
    -Name 'SvcHostSplitDisable' `
    -Type 'DWord' `
    -Value 1 `
    -Desc 'Disable SvcHost split for SamSs'